...
const PublishBlogPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://backend-codershangout.vercel.app/store/blog', {
        method: 'POST',
        body: form_data,
      });
    ...
    <div className="min-h-screen flex flex-col bg-gray-900 text-gray-100">
      ...
      <main className="flex-grow container mx-auto px-4 py-10">
        <div className="max-w-3xl mx-auto bg-gray-800 rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold mb-8 text-center text-blue-400">Publish New Blog</h1>
